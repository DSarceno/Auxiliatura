...
\bibitem{b1} Arfken, G. B., \& Weber, H. J. (2013). \textit{Mathematical methods for physicists.}
%\bibitem{b2} Chow, T. L. (2000). \textit{Mathematical Methods for Physicists: A concise introduction}. Cambridge University Press.
%\bibitem{b3} Antuña, J. (2014). \textit{Métodos Matemáticos de la Física.} Editorial Universitaria La Habana Cuba.
\end{thebibliography}
